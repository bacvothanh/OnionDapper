...
!function($) {
    ...
    CalendarApp.prototype.onEventClick =  function (calEvent, jsEvent, view) {
        var $this = this;
            var form = $("<form></form>");
            form.append("<label>Tên cuộc hẹn</label>");
    ...
    CalendarApp.prototype.onSelect = function (start, end, allDay) {
        var $this = this;
            ...
            form.find(".row")
                .append("<div class='col-md-6'><div class='form-group'><label class='control-label'>Tên cuộc hẹn</label><input class='form-control' placeholder='' type='text' name='title'/></div></div>")
                .append("<div class='col-md-6'><div class='form-group'><label class='control-label'>Độ ưu tiên</label><select class='form-control' name='category'></select></div></div>")
            ...
            $this.$modal.find('form').on('submit', function () {
                ...
                if (title !== null && title.length != 0) {
                    ...
                    alert('Thiếu thông tin Tên cuộc hẹn');
                }
                return false;
